...
\section{Endlichkeit der Homotopiegruppen der Sphären}
...
% Hatcher, 1.21
\begin{satz}
  Die Homotopiegruppen $\pi_i(S^n, *)$,~$i > n$, sind endlich bis auf die Gruppen $\pi_{4k-1}(S^{2k})$, $k \geq 1$, welche jeweils isomorph zu einer direkten Summe von $\Z$ mit einer endlichen Gruppe sind.
\end{satz}
...
% TODO für 31.7.2015:
% * Masterbewerbung abgeben (bis 12:00!)
