...
\begin{lem}
  ...
  \begin{enumerate}[label=\alph*)]
    \item $\FG \coloneqq \{\, \text{endlich erzeugte ab. Gruppen} \,\}$
    \item $\F \coloneqq \{\, \text{endliche ab. Gruppen} \,\}$
...
Dabei hat man $\tau_{< n+1} X$ aus $X$ durch Ankleben von Zellen der Dimension $\geq n+2$ zum Töten der Homotopiegruppen in Grad $\geq n+1$ konstruiert.
