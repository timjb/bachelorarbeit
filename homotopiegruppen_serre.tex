...
\begin{satz}[Jean-Pierre Serre]
  Es sei $G$ eine abelsche Gruppe und $p : E \to B$ eine Faserung.
...
\begin{satz}
  Es sei $R$ ein Ring, $p : E \to B$ eine Faserung.
...
% * Bei der Technik, wie man Abbildungen in Faserungen umwandelt: Ist die Wirkung immer trivial?
...
% * Vergleich mit dem Ansatz von Serre in seiner Dissertation
% * Motivation für Studium der Homotopiegruppen der Sphären beschreiben
% * Switzer zu Pontryagin-Thom zitieren
